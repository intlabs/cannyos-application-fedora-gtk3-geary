#!/bin/sh
#
# CannyOS cannyos-application-fedora-gtk3-geary container build script
#
# https://github.com/intlabs/cannyos-application-fedora-gtk3-geary
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-application-fedora-gtk3-geary/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo mkdir -p "/CannyOS/build/cannyos-application-fedora-gtk3-geary"
# Ensure that there it is clear
sudo rm -r -f "/CannyOS/build/cannyos-application-fedora-gtk3-geary/*"
...
sudo docker run -i -t -d \
 ...
 --user "root" \
 -p 80 \
 intlabs/cannyos-application-fedora-gtk3-geary 
